...
namespace SharpFace
{
    ...
    public class LandmarkDetector
    {
        ...
        {
            LandmarkDetectorPINVOKE.get_video_input_output_params(input_video_file.Pointer, output_files.Pointer, output_video_files.Pointer, out world_coordinates_pose, out output_codec, arguments.Pointer);
            if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
        }
        ...
        {
            LandmarkDetectorPINVOKE.get_camera_params(out device, out fx, out fy, out cx, out cy, arguments.Pointer);
            if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
        }
        ...
        {
            bool ret = LandmarkDetectorPINVOKE.DetectSingleFaceHOG__SWIG_0(o_region.Pointer, intensity.Pointer, classifier.Pointer, out confidence, preference.Pointer);
            if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            bool ret = LandmarkDetectorPINVOKE.DetectSingleFaceHOG__SWIG_1(o_region.Pointer, intensity.Pointer, classifier.Pointer, out confidence);
            if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
