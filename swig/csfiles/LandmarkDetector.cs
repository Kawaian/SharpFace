...
public class LandmarkDetector {
  ...
  public static void get_video_input_output_params(SWIGTYPE_p_vectorT_string_t input_video_file, SWIGTYPE_p_vectorT_string_t output_files, SWIGTYPE_p_vectorT_string_t output_video_files, SWIGTYPE_p_bool world_coordinates_pose, SWIGTYPE_p_string output_codec, SWIGTYPE_p_vectorT_string_t arguments) {
    LandmarkDetectorPINVOKE.get_video_input_output_params(SWIGTYPE_p_vectorT_string_t.getCPtr(input_video_file), SWIGTYPE_p_vectorT_string_t.getCPtr(output_files), SWIGTYPE_p_vectorT_string_t.getCPtr(output_video_files), SWIGTYPE_p_bool.getCPtr(world_coordinates_pose), SWIGTYPE_p_string.getCPtr(output_codec), SWIGTYPE_p_vectorT_string_t.getCPtr(arguments));
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void get_camera_params(SWIGTYPE_p_int device, SWIGTYPE_p_float fx, SWIGTYPE_p_float fy, SWIGTYPE_p_float cx, SWIGTYPE_p_float cy, SWIGTYPE_p_vectorT_string_t arguments) {
    LandmarkDetectorPINVOKE.get_camera_params(SWIGTYPE_p_int.getCPtr(device), SWIGTYPE_p_float.getCPtr(fx), SWIGTYPE_p_float.getCPtr(fy), SWIGTYPE_p_float.getCPtr(cx), SWIGTYPE_p_float.getCPtr(cy), SWIGTYPE_p_vectorT_string_t.getCPtr(arguments));
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void get_image_input_output_params(SWIGTYPE_p_vectorT_string_t input_image_files, SWIGTYPE_p_vectorT_string_t output_feature_files, SWIGTYPE_p_vectorT_string_t output_pose_files, SWIGTYPE_p_vectorT_string_t output_image_files, SWIGTYPE_p_vectorT_cv__Rect_T_double_t_t input_bounding_boxes, SWIGTYPE_p_vectorT_string_t arguments) {
    LandmarkDetectorPINVOKE.get_image_input_output_params(SWIGTYPE_p_vectorT_string_t.getCPtr(input_image_files), SWIGTYPE_p_vectorT_string_t.getCPtr(output_feature_files), SWIGTYPE_p_vectorT_string_t.getCPtr(output_pose_files), SWIGTYPE_p_vectorT_string_t.getCPtr(output_image_files), SWIGTYPE_p_vectorT_cv__Rect_T_double_t_t.getCPtr(input_bounding_boxes), SWIGTYPE_p_vectorT_string_t.getCPtr(arguments));
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public static SWIGTYPE_p_vectorT_std__pairT_cv__Point2d_cv__Point2d_t_t CalculateBox(SWIGTYPE_p_cv__Vec6d pose, float fx, float fy, float cx, float cy) {
    SWIGTYPE_p_vectorT_std__pairT_cv__Point2d_cv__Point2d_t_t ret = new SWIGTYPE_p_vectorT_std__pairT_cv__Point2d_cv__Point2d_t_t(LandmarkDetectorPINVOKE.CalculateBox(SWIGTYPE_p_cv__Vec6d.getCPtr(pose), fx, fy, cx, cy), true);
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static void DrawBox(SWIGTYPE_p_vectorT_pairT_cv__Point_cv__Point_t_t lines, SWIGTYPE_p_cv__Mat image, SWIGTYPE_p_cv__Scalar color, int thickness) {
    LandmarkDetectorPINVOKE.DrawBox__SWIG_1(SWIGTYPE_p_vectorT_pairT_cv__Point_cv__Point_t_t.getCPtr(lines), SWIGTYPE_p_cv__Mat.getCPtr(image), SWIGTYPE_p_cv__Scalar.getCPtr(color), thickness);
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
  }

  public static SWIGTYPE_p_vectorT_cv__Point2d_t CalculateLandmarks(SWIGTYPE_p_cv__Mat_T_double_t shape2D, SWIGTYPE_p_cv__Mat_T_int_t visibilities) {
    SWIGTYPE_p_vectorT_cv__Point2d_t ret = new SWIGTYPE_p_vectorT_cv__Point2d_t(LandmarkDetectorPINVOKE.CalculateLandmarks__SWIG_0(SWIGTYPE_p_cv__Mat_T_double_t.getCPtr(shape2D), SWIGTYPE_p_cv__Mat_T_int_t.getCPtr(visibilities)), true);
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static SWIGTYPE_p_vectorT_cv__Point2d_t CalculateLandmarks(CLNF clnf_model) {
    SWIGTYPE_p_vectorT_cv__Point2d_t ret = new SWIGTYPE_p_vectorT_cv__Point2d_t(LandmarkDetectorPINVOKE.CalculateLandmarks__SWIG_1(CLNF.getCPtr(clnf_model)), true);
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static void DrawLandmarks(SWIGTYPE_p_cv__Mat img, SWIGTYPE_p_vectorT_cv__Point_t landmarks) {
    LandmarkDetectorPINVOKE.DrawLandmarks(SWIGTYPE_p_cv__Mat.getCPtr(img), SWIGTYPE_p_vectorT_cv__Point_t.getCPtr(landmarks));
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public static bool DetectFaces(SWIGTYPE_p_vectorT_cv__Rect_T_double_t_t o_regions, SWIGTYPE_p_cv__Mat_T_uchar_t intensity) {
    bool ret = LandmarkDetectorPINVOKE.DetectFaces__SWIG_0(SWIGTYPE_p_vectorT_cv__Rect_T_double_t_t.getCPtr(o_regions), SWIGTYPE_p_cv__Mat_T_uchar_t.getCPtr(intensity));
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static bool DetectFaces(SWIGTYPE_p_vectorT_cv__Rect_T_double_t_t o_regions, SWIGTYPE_p_cv__Mat_T_uchar_t intensity, SWIGTYPE_p_cv__CascadeClassifier classifier) {
    bool ret = LandmarkDetectorPINVOKE.DetectFaces__SWIG_1(SWIGTYPE_p_vectorT_cv__Rect_T_double_t_t.getCPtr(o_regions), SWIGTYPE_p_cv__Mat_T_uchar_t.getCPtr(intensity), SWIGTYPE_p_cv__CascadeClassifier.getCPtr(classifier));
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static bool DetectFacesHOG(SWIGTYPE_p_vectorT_cv__Rect_T_double_t_t o_regions, SWIGTYPE_p_cv__Mat_T_uchar_t intensity, SWIGTYPE_p_std__vectorT_double_t confidences) {
    bool ret = LandmarkDetectorPINVOKE.DetectFacesHOG__SWIG_0(SWIGTYPE_p_vectorT_cv__Rect_T_double_t_t.getCPtr(o_regions), SWIGTYPE_p_cv__Mat_T_uchar_t.getCPtr(intensity), SWIGTYPE_p_std__vectorT_double_t.getCPtr(confidences));
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static bool DetectFacesHOG(SWIGTYPE_p_vectorT_cv__Rect_T_double_t_t o_regions, SWIGTYPE_p_cv__Mat_T_uchar_t intensity, SWIGTYPE_p_dlib__frontal_face_detector classifier, SWIGTYPE_p_std__vectorT_double_t confidences) {
    bool ret = LandmarkDetectorPINVOKE.DetectFacesHOG__SWIG_1(SWIGTYPE_p_vectorT_cv__Rect_T_double_t_t.getCPtr(o_regions), SWIGTYPE_p_cv__Mat_T_uchar_t.getCPtr(intensity), SWIGTYPE_p_dlib__frontal_face_detector.getCPtr(classifier), SWIGTYPE_p_std__vectorT_double_t.getCPtr(confidences));
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static bool DetectSingleFaceHOG(SWIGTYPE_p_cv__Rect_T_double_t o_region, SWIGTYPE_p_cv__Mat_T_uchar_t intensity, SWIGTYPE_p_dlib__frontal_face_detector classifier, SWIGTYPE_p_double confidence, SWIGTYPE_p_cv__Point preference) {
    bool ret = LandmarkDetectorPINVOKE.DetectSingleFaceHOG__SWIG_0(SWIGTYPE_p_cv__Rect_T_double_t.getCPtr(o_region), SWIGTYPE_p_cv__Mat_T_uchar_t.getCPtr(intensity), SWIGTYPE_p_dlib__frontal_face_detector.getCPtr(classifier), SWIGTYPE_p_double.getCPtr(confidence), SWIGTYPE_p_cv__Point.getCPtr(preference));
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static bool DetectSingleFaceHOG(SWIGTYPE_p_cv__Rect_T_double_t o_region, SWIGTYPE_p_cv__Mat_T_uchar_t intensity, SWIGTYPE_p_dlib__frontal_face_detector classifier, SWIGTYPE_p_double confidence) {
    bool ret = LandmarkDetectorPINVOKE.DetectSingleFaceHOG__SWIG_1(SWIGTYPE_p_cv__Rect_T_double_t.getCPtr(o_region), SWIGTYPE_p_cv__Mat_T_uchar_t.getCPtr(intensity), SWIGTYPE_p_dlib__frontal_face_detector.getCPtr(classifier), SWIGTYPE_p_double.getCPtr(confidence));
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
