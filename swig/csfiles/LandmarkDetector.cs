...
namespace SharpFace
{
    ...
    public class LandmarkDetector
    {
        ...
        public static void get_video_input_output_params(StringList input_video_file, StringList output_files, StringList output_video_files, /* cstype */ out bool world_coordinates_pose, SWIGTYPE_p_std__string output_codec, StringList arguments)
        {
            LandmarkDetectorPINVOKE.get_video_input_output_params(StringList.getCPtr(input_video_file), StringList.getCPtr(output_files), StringList.getCPtr(output_video_files), out world_coordinates_pose, SWIGTYPE_p_std__string.getCPtr(output_codec), StringList.getCPtr(arguments));
            if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
        }
