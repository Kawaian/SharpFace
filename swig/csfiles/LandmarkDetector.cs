...
public class LandmarkDetector {
  ...
  public static void get_video_input_output_params(StringList input_video_file, StringList output_files, StringList output_video_files, SWIGTYPE_p_bool world_coordinates_pose, /*cstype*/ out string output_codec, StringList arguments) {
    LandmarkDetectorPINVOKE.get_video_input_output_params(StringList.getCPtr(input_video_file), StringList.getCPtr(output_files), StringList.getCPtr(output_video_files), SWIGTYPE_p_bool.getCPtr(world_coordinates_pose), out output_codec, StringList.getCPtr(arguments));
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public static void get_camera_params(SWIGTYPE_p_int device, SWIGTYPE_p_float fx, SWIGTYPE_p_float fy, SWIGTYPE_p_float cx, SWIGTYPE_p_float cy, StringList arguments) {
    LandmarkDetectorPINVOKE.get_camera_params(SWIGTYPE_p_int.getCPtr(device), SWIGTYPE_p_float.getCPtr(fx), SWIGTYPE_p_float.getCPtr(fy), SWIGTYPE_p_float.getCPtr(cx), SWIGTYPE_p_float.getCPtr(cy), StringList.getCPtr(arguments));
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
  }
