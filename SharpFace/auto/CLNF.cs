...
public class CLNF : global::System.IDisposable {
  ...
  public SWIGTYPE_p_vectorT_LandmarkDetector__CLNF_t hierarchical_models {
    set {
      LandmarkDetectorPINVOKE.CLNF_hierarchical_models_set(swigCPtr, SWIGTYPE_p_vectorT_LandmarkDetector__CLNF_t.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = LandmarkDetectorPINVOKE.CLNF_hierarchical_models_get(swigCPtr);
      SWIGTYPE_p_vectorT_LandmarkDetector__CLNF_t ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_vectorT_LandmarkDetector__CLNF_t(cPtr, false);
      return ret;
    } 
  }

  public SWIGTYPE_p_vectorT_string_t hierarchical_model_names {
    set {
      LandmarkDetectorPINVOKE.CLNF_hierarchical_model_names_set(swigCPtr, SWIGTYPE_p_vectorT_string_t.getCPtr(value));
      if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      SWIGTYPE_p_vectorT_string_t ret = new SWIGTYPE_p_vectorT_string_t(LandmarkDetectorPINVOKE.CLNF_hierarchical_model_names_get(swigCPtr), true);
      if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }

  public SWIGTYPE_p_vectorT_vectorT_pairT_int_int_t_t_t hierarchical_mapping {
    set {
      LandmarkDetectorPINVOKE.CLNF_hierarchical_mapping_set(swigCPtr, SWIGTYPE_p_vectorT_vectorT_pairT_int_int_t_t_t.getCPtr(value));
      if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      SWIGTYPE_p_vectorT_vectorT_pairT_int_int_t_t_t ret = new SWIGTYPE_p_vectorT_vectorT_pairT_int_int_t_t_t(LandmarkDetectorPINVOKE.CLNF_hierarchical_mapping_get(swigCPtr), true);
      if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }

  public SWIGTYPE_p_vectorT_FaceModelParameters_t hierarchical_params {
    set {
      LandmarkDetectorPINVOKE.CLNF_hierarchical_params_set(swigCPtr, SWIGTYPE_p_vectorT_FaceModelParameters_t.getCPtr(value));
      if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      SWIGTYPE_p_vectorT_FaceModelParameters_t ret = new SWIGTYPE_p_vectorT_FaceModelParameters_t(LandmarkDetectorPINVOKE.CLNF_hierarchical_params_get(swigCPtr), true);
      if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
  ...
  public SWIGTYPE_p_string face_detector_location {
    set {
      LandmarkDetectorPINVOKE.CLNF_face_detector_location_set(swigCPtr, SWIGTYPE_p_string.getCPtr(value));
      if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      SWIGTYPE_p_string ret = new SWIGTYPE_p_string(LandmarkDetectorPINVOKE.CLNF_face_detector_location_get(swigCPtr), true);
      if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
  ...
  public SWIGTYPE_p_vectorT_cv__Mat_T_int_t_t triangulations {
    set {
      LandmarkDetectorPINVOKE.CLNF_triangulations_set(swigCPtr, SWIGTYPE_p_vectorT_cv__Mat_T_int_t_t.getCPtr(value));
      if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      SWIGTYPE_p_vectorT_cv__Mat_T_int_t_t ret = new SWIGTYPE_p_vectorT_cv__Mat_T_int_t_t(LandmarkDetectorPINVOKE.CLNF_triangulations_get(swigCPtr), true);
      if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
  ...
  public CLNF(SWIGTYPE_p_string fname) : this(LandmarkDetectorPINVOKE.new_CLNF__SWIG_1(SWIGTYPE_p_string.getCPtr(fname)), true) {
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void Read(SWIGTYPE_p_string name) {
    LandmarkDetectorPINVOKE.CLNF_Read(swigCPtr, SWIGTYPE_p_string.getCPtr(name));
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Read_CLNF(SWIGTYPE_p_string clnf_location) {
    LandmarkDetectorPINVOKE.CLNF_Read_CLNF(swigCPtr, SWIGTYPE_p_string.getCPtr(clnf_location));
    if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
  }
