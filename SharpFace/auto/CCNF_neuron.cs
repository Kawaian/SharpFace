...
public class CCNF_neuron : global::System.IDisposable {
  ...
  public SWIGTYPE_p_std__mapT_int_cv__Mat_T_double_t_t weights_dfts {
    set {
      LandmarkDetectorPINVOKE.CCNF_neuron_weights_dfts_set(swigCPtr, SWIGTYPE_p_std__mapT_int_cv__Mat_T_double_t_t.getCPtr(value));
      if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      SWIGTYPE_p_std__mapT_int_cv__Mat_T_double_t_t ret = new SWIGTYPE_p_std__mapT_int_cv__Mat_T_double_t_t(LandmarkDetectorPINVOKE.CCNF_neuron_weights_dfts_get(swigCPtr), true);
      if (LandmarkDetectorPINVOKE.SWIGPendingException.Pending) throw LandmarkDetectorPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
